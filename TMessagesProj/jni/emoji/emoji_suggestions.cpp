...
jobjectArray
Java_org_privalino_messenger_Emoji_getSuggestion(JNIEnv *env, jobject object, jstring query) {
    ...
    if (jclass_Suggestion == nullptr) {
        jclass_Suggestion = (jclass) env->NewGlobalRef(env->FindClass("org/privalino/messenger/EmojiSuggestion"));
