...
import org.privalino.messenger.exoplayer2.source.chunk.ChunkSampleStream;
...
import org.privalino.messenger.exoplayer2.upstream.Allocator;
...
import org.privalino.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener.EventDispatcher;
import org.privalino.messenger.exoplayer2.source.CompositeSequenceableLoader;
import org.privalino.messenger.exoplayer2.source.EmptySampleStream;
import org.privalino.messenger.exoplayer2.source.MediaPeriod;
import org.privalino.messenger.exoplayer2.source.SampleStream;
import org.privalino.messenger.exoplayer2.source.SequenceableLoader;
import org.privalino.messenger.exoplayer2.source.TrackGroup;
import org.privalino.messenger.exoplayer2.source.TrackGroupArray;
import org.privalino.messenger.exoplayer2.source.chunk.ChunkSampleStream;
import org.privalino.messenger.exoplayer2.source.chunk.ChunkSampleStream.EmbeddedSampleStream;
import org.privalino.messenger.exoplayer2.source.dash.manifest.AdaptationSet;
import org.privalino.messenger.exoplayer2.source.dash.manifest.DashManifest;
import org.privalino.messenger.exoplayer2.source.dash.manifest.Descriptor;
import org.privalino.messenger.exoplayer2.source.dash.manifest.Representation;
import org.privalino.messenger.exoplayer2.trackselection.TrackSelection;
import org.privalino.messenger.exoplayer2.upstream.Allocator;
import org.privalino.messenger.exoplayer2.upstream.LoaderErrorThrower;
...
/* package */ final class DashMediaPeriod implements MediaPeriod,
  ...
  public long selectTracks(TrackSelection[] selections, boolean[] mayRetainStreamFlags,
    ...
    for (int i = 0; i < selections.length; i++) {
      if ((streams[i] instanceof ChunkSampleStream.EmbeddedSampleStream || streams[i] instanceof EmptySampleStream)
      ...
      if (selections[i] != null) {
        ...
        if (!trackGroupInfo.isPrimary) {
          ...
          boolean mayRetainStream = primaryStream == null ? stream instanceof EmptySampleStream
              : (stream instanceof ChunkSampleStream.EmbeddedSampleStream
                  && ((ChunkSampleStream.EmbeddedSampleStream) stream).parent == primaryStream);
          if (!mayRetainStream) {
