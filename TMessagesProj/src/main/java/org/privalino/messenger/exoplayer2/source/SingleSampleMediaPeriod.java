...
import org.privalino.messenger.exoplayer2.decoder.DecoderInputBuffer;
import org.privalino.messenger.exoplayer2.source.SingleSampleMediaSource.EventListener;
import org.privalino.messenger.exoplayer2.trackselection.TrackSelection;
import org.privalino.messenger.exoplayer2.upstream.DataSource;
import org.privalino.messenger.exoplayer2.upstream.DataSpec;
import org.privalino.messenger.exoplayer2.upstream.Loader;
...
/* package */ final class SingleSampleMediaPeriod implements MediaPeriod,
  ...
  public SingleSampleMediaPeriod(Uri uri, DataSource.Factory dataSourceFactory, Format format,
      int minLoadableRetryCount, Handler eventHandler, SingleSampleMediaSource.EventListener eventListener,
      int eventSourceId) {
    this.uri = uri;
