 ...
 */
package org.privalino.messenger.exoplayer2.source.dash.manifest;
...
import org.privalino.messenger.exoplayer2.extractor.mp4.PsshAtomUtil;
...
import org.privalino.messenger.exoplayer2.drm.DrmInitData;
import org.privalino.messenger.exoplayer2.drm.DrmInitData.SchemeData;
import org.privalino.messenger.exoplayer2.extractor.mp4.PsshAtomUtil;
import org.privalino.messenger.exoplayer2.source.dash.manifest.SegmentBase.SegmentList;
import org.privalino.messenger.exoplayer2.source.dash.manifest.SegmentBase.SegmentTemplate;
import org.privalino.messenger.exoplayer2.source.dash.manifest.SegmentBase.SegmentTimelineElement;
import org.privalino.messenger.exoplayer2.source.dash.manifest.SegmentBase.SingleSegmentBase;
import org.privalino.messenger.exoplayer2.upstream.ParsingLoadable;
import org.privalino.messenger.exoplayer2.util.Assertions;
import org.privalino.messenger.exoplayer2.util.MimeTypes;
import org.privalino.messenger.exoplayer2.util.UriUtil;
import org.privalino.messenger.exoplayer2.util.Util;
import org.privalino.messenger.exoplayer2.util.XmlPullParserUtil;
...
public class DashManifestParser extends DefaultHandler
  ...
  protected SegmentBase.SingleSegmentBase buildSingleSegmentBase(RangedUri initialization, long timescale,
    ...
    return new SegmentBase.SingleSegmentBase(initialization, timescale, presentationTimeOffset, indexStart,
        indexLength);
  }

  protected SegmentBase.SegmentList parseSegmentList(XmlPullParser xpp, SegmentBase.SegmentList parent)
      throws XmlPullParserException, IOException {
  ...
  protected SegmentBase.SegmentTemplate parseSegmentTemplate(XmlPullParser xpp, SegmentBase.SegmentTemplate parent)
      throws XmlPullParserException, IOException {
    long timescale = parseLong(xpp, "timescale", parent != null ? parent.timescale : 1);
    long presentationTimeOffset = parseLong(xpp, "presentationTimeOffset",
        parent != null ? parent.presentationTimeOffset : 0);
