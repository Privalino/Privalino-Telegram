 ...
 */
package org.privalino.messenger.exoplayer2;
...
import org.privalino.messenger.exoplayer2.source.ClippingMediaPeriod;
...
import org.privalino.messenger.exoplayer2.trackselection.TrackSelector;
import org.privalino.messenger.exoplayer2.trackselection.TrackSelectorResult;
import org.privalino.messenger.exoplayer2.util.Assertions;
import org.privalino.messenger.exoplayer2.util.MediaClock;
import org.privalino.messenger.exoplayer2.util.StandaloneMediaClock;
import org.privalino.messenger.exoplayer2.util.TraceUtil;
import org.privalino.messenger.exoplayer2.ExoPlayer.ExoPlayerMessage;
import org.privalino.messenger.exoplayer2.MediaPeriodInfoSequence.MediaPeriodInfo;
import org.privalino.messenger.exoplayer2.source.ClippingMediaPeriod;
import org.privalino.messenger.exoplayer2.source.MediaPeriod;
import org.privalino.messenger.exoplayer2.source.MediaSource;
import org.privalino.messenger.exoplayer2.source.MediaSource.MediaPeriodId;
import org.privalino.messenger.exoplayer2.source.SampleStream;
import org.privalino.messenger.exoplayer2.trackselection.TrackSelection;
import org.privalino.messenger.exoplayer2.trackselection.TrackSelectionArray;
import org.privalino.messenger.exoplayer2.trackselection.TrackSelector;
...
/* package */ final class ExoPlayerImplInternal implements Handler.Callback,
  ...
  public static final class PlaybackInfo {
    ...
    public PlaybackInfo(int periodIndex, long startPositionUs) {
      this(new MediaSource.MediaPeriodId(periodIndex), startPositionUs);
    }

    public PlaybackInfo(MediaSource.MediaPeriodId periodId, long startPositionUs) {
      this(periodId, startPositionUs, C.TIME_UNSET);
    }

    public PlaybackInfo(MediaSource.MediaPeriodId periodId, long startPositionUs, long contentPositionUs) {
  ...
  private void setRepeatModeInternal(@Player.RepeatMode int repeatMode)
    ...
    if (!seenReadingPeriodHolder && playingPeriodHolder != null) {
      ...
      MediaSource.MediaPeriodId periodId = playingPeriodHolder.info.id;
  ...
  private boolean shouldKeepPeriodHolder(MediaSource.MediaPeriodId seekPeriodId, long positionUs,
  ...
  private void handleSourceInfoRefreshed(Pair<Timeline, Object> timelineAndManifest)
    ...
    if (oldTimeline == null) {
      if (pendingInitialSeekCount > 0) {
        ...
        if (timeline.isEmpty()) {
          ...
          MediaSource.MediaPeriodId periodId = mediaPeriodInfoSequence.resolvePeriodPositionForAds(periodIndex,
              startPositionUs);
    ...
    if (periodIndex == C.INDEX_UNSET) {
      ...
      MediaSource.MediaPeriodId periodId = new MediaSource.MediaPeriodId(newPeriodIndex);
