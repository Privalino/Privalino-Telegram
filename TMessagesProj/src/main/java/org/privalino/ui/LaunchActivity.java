...
import org.privalino.ui.ActionBar.DrawerLayoutContainer;
import org.privalino.ui.ActionBar.Theme;
import org.privalino.ui.Adapters.DrawerLayoutAdapter;
import org.privalino.ui.Cells.LanguageCell;
...
import org.privalino.messenger.LocationController;
...
import org.privalino.messenger.camera.CameraController;
...
import org.privalino.ui.Components.AudioPlayerAlert;
...
import org.privalino.ui.Components.PasscodeView;
import org.privalino.ui.Components.RecyclerListView;
import org.privalino.ui.Components.SharingLocationsAlert;
import org.privalino.ui.Components.StickersAlert;
import org.privalino.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("org.privalino.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
