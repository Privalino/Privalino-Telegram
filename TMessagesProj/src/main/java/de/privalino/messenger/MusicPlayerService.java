...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "de.privalino.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "de.privalino.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "de.privalino.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "de.privalino.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "de.privalino.android.musicplayer.next";
