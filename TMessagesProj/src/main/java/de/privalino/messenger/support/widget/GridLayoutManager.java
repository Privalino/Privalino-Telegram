...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private void ensureAnchorIsInCorrectSpan(RecyclerView.Recycler recycler,
        ...
        final boolean layingOutInPrimaryDirection =
                itemDirection == de.privalino.messenger.support.widget.LayoutState.ITEM_DIRECTION_TAIL;
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        final boolean layingOutInPrimaryDirection =
                layoutState.mItemDirection == de.privalino.messenger.support.widget.LayoutState.ITEM_DIRECTION_TAIL;
        int count = 0;
        ...
        if (mOrientation == VERTICAL) {
            if (layoutState.mLayoutDirection == de.privalino.messenger.support.widget.LayoutState.LAYOUT_START) {
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
        ...
        final boolean ascend = (layoutDir == de.privalino.messenger.support.widget.LayoutState.LAYOUT_END) != mShouldReverseLayout;
