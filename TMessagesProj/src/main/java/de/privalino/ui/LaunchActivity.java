...
import de.privalino.ui.ActionBar.DrawerLayoutContainer;
import de.privalino.ui.ActionBar.Theme;
import de.privalino.ui.Adapters.DrawerLayoutAdapter;
import de.privalino.ui.Cells.LanguageCell;
...
import de.privalino.messenger.LocationController;
...
import de.privalino.messenger.camera.CameraController;
...
import de.privalino.ui.Components.AudioPlayerAlert;
...
import de.privalino.ui.Components.PasscodeView;
import de.privalino.ui.Components.RecyclerListView;
import de.privalino.ui.Components.SharingLocationsAlert;
import de.privalino.ui.Components.StickersAlert;
import de.privalino.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("de.privalino.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
